			...
			<div class="col-md-12">
				<div class="wrapper">
					<div class="row no-gutters terms_content">
						<div class="col-md-12">
							<div class="contact-wrap w-100 p-md-5 p-4" style="text-align: center;">

								
								<button onclick="requestPay()" value="카드결제" class="btn btn-primary" style=" display: inline-block;">결제하기</button>
								...
								<form method="post" action="/anymoremall/afterImport">
									...
									<c:if test="${kind ne 1}">
										<input type="hidden" class="form-control" id='product_name' name='product_name' value = '<%= product_name %> 외 <%=cnt %>개' />
									</c:if>
