    	...
    	<c:forEach items="${ar_list}" var="adoptionReview">            
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4"><b><c:out value="${adoptionReview.title }" /></b></p>
                    <p><c:out value="${adoptionReview.content }" /></p>
                    <div class="d-flex align-items-center">
                    	<!-- <div class="user-img" style="background-image: url(images/dog2.jpg)"></div> -->
                    <c:forEach items="${ar_img}" var="image">
	  					<c:if test="${adoptionReview.bno == image.bno }">
							<img class="user-img" src="/display?fileName=${ image.uploadPath }/${ image.uuid }_${ image.fileName }"/>
						</c:if> 
					</c:forEach>
                    	<div class="pl-3">
