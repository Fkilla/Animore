					 ...
					 style="cursor:pointer;">
  					<c:forEach items="${animal_file}" var="protectImage">
	  					<c:if test="${ protectList.board_num == protectImage.board_num }">
							<a href="/adopt/animalDetails?board_num=${ protectList.board_num }"><img class="img-fluid rounded" src="/adopt/protectAnimalDisplay?fileName=${ protectImage.uploadPath }/${ protectImage.uuid }_${ protectImage.fileName }"/></a>
						</c:if> 
					</c:forEach>					 
                  <div class="text p-4">
                    <div class="meta mb-2">
