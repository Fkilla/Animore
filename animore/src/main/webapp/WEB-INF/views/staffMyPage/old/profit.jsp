  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end">
      <div class="col-md-12 ftco-animate pb-5">
        <h1 class="mb-0 bread">관리자 마이페이지 - 매출액</h1>
      ...
      <container>
        <div class="container">
          <div class="row no-gutters slider-text align-items-end">
			...
			<input type='hidden' name='perchase_name' value='<c:out value="${pageMaker.cri.perchase_name}"/>'/>
			<input type='hidden' name='delivery' value='<c:out value="${pageMaker.cri.delivery}"/>'/>
